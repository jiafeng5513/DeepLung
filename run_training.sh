...
maxeps=150
f=9
CUDA_VISIBLE_DEVICES=0,1,2,3 /usr/local/anaconda2/bin/python main.py --model dpn3d26 -b 16 --save-dir res18/retrft96$f/ --epochs $maxeps --config config_training$f
